...
export default function NamaFijiSection() {
  return (
    <section id="off-menu" className="relative py-28 md:py-36 bg-terracotta overflow-hidden">
      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-cream mb-6 leading-[1.05] max-w-2xl">
        ...
        >
          ...
          <p className="text-cream/90 text-lg text-center font-serif italic mb-12">
